<?php
    ...
    $db = new Database();
    $roles = $db->findAll('t_roles', [], 'id', 'DESC');
...
<div class="container">
    ...
    <pre>
        Tạm thời chỉ phân 2 quyền USER và ADMIN>
        Sẽ phát triển lại và phân quyền lại theo chức năng
    </pre>
    <!-- Form Thêm Quyền -->
    <div class="add-role">
        ...
        <form id="add-role-form" method="POST">
            ...
            <button disabled type="submit" class="btn btn-primary">Thêm Quyền</button>
        </form>
    </div>
