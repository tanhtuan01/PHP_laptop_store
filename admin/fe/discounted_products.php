    ...
    <table>
        <thead>
            <tr>
                ...
                <th style="width: 150px;text-align:center">Giá gốc</th>
                <th style="width: 50px;text-align:center">% giảm</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="width: 100px;text-align:center">
                    <!-- <a href="./index.php?page=edit_product&id=<?php echo $product['id']; ?>">Sử</a> |  -->
